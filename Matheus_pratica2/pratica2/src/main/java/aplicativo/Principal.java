...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Produto p1 = new Produto("Monitor", 850);
            Produto p2 = new Produto("Mouse", 200);
            Produto p3 = new Produto("Teclado", 350);
            Produto p4 = new Produto("Fone de Ouvido", 120);
            ...
            Cliente c1 = new Cliente("Maurício");
            Cliente c2 = new Cliente("Marta");
            Cliente c3 = new Cliente("Lorrane");
            Cliente c4 = new Cliente("Isabela");
